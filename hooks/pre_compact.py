"""PreCompact hook for claude-mnemos plugin.
...
job to the local mnemos daemon (port read from ``GlobalSettings``) with
extract=False and raw_filename_suffix="-precompact"; on daemon failure falls
back to a detached ``mnemos ingest <t> --project NAME`` subprocess. Hook never
blocks: returns 0 unconditionally.
...
install_excepthook("pre_compact")
        ...
        response = httpx.post(
            ...
            json={
                ...
                "payload": {
                    ...
                    "extract": False,
                    "raw_filename_suffix": "-precompact",
                },
            },
...
if __name__ == "__main__":
    try:
        ...
        record_exception(hook="pre_compact", exc=e, context={"argv": sys.argv})
