    ...
    "translation",
    {
      settings: {
        ...
        section: {
          telemetry: {
            title: "Telemetry",
            opt_in: "Send anonymous usage stats",
            hint: "No prompts, transcripts, or vault content is ever sent.",
          },
        },
      },
    },
...
describe("TelemetrySection", () => {
  ...
  it("toggle opt_in enables Save and PATCHes", async () => {
    vi.mocked(apiClient.get).mockResolvedValueOnce({ data: FULL });
